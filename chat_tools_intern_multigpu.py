...
os.environ["CUDA_VISIBLE_DEVICES"] = "1,2,3,4,5"  # <- 删除这类硬编码
# 修改模型路径
...
3.  **总体判定**: 综合配对分析结果，给出【图像1-图像2-文本1】的总体关系。判定遵循**最高优先级原则：因果> 矛盾 > 关联 > 等价**。 注意：若在关系判定的分析中一对关系出现了因果/矛盾关系，则可以直接据此判定总体关系为因果/矛盾关系。
